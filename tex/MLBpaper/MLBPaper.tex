...
Decision trees, while useful, have their limitations. Firstly, it is possible to grow overly complex trees that overfit the training data \cite{ISLR}. In such cases, a method known as pruning is required to combat this problem. Pruning a decision tree amounts to 
